...
public class FileDownloader {
    ...
    public String downloadFile(String link , String name) throws Exception {
        return downloader(link, name);
    }
    ...
    private String downloader(WebElement element, String attribute) throws IOException, NullPointerException, URISyntaxException {
        ...
        //String fileToDownloadLocation = "http://www.servico.corag.com.br/diarioOficial/jornal.php";
        if (fileToDownloadLocation.trim().equals("")) throw new NullPointerException("The element you have specified does not link to anything!");
 
        URL fileToDownload = new URL(fileToDownloadLocation);
        File downloadedFile = new File("src/resources/temp/funcionou2.pdf");
    ...
    private String downloader(String link , String name) throws IOException, NullPointerException, URISyntaxException {
        String fileToDownloadLocation = link;
        //String fileToDownloadLocation = "http://www.servico.corag.com.br/diarioOficial/jornal.php";
        if (fileToDownloadLocation.trim().equals("")) throw new NullPointerException("The element you have specified does not link to anything!");
 
        URL fileToDownload = new URL(fileToDownloadLocation);
        File downloadedFile = new File(name);
        if (downloadedFile.canWrite() == false) downloadedFile.setWritable(true);
